...
class _ShareVerseScreenState extends ConsumerState<ShareVerseScreen> {
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          ShareVerseFonts.displayNames[currentFont] ?? currentFont,
    ...
    showModalBottomSheet(
      ...
      builder: (_) => SizedBox(
        ...
        child: ListView.builder(
          itemCount: ShareVerseFonts.fonts.keys.length,
          itemBuilder: (ctx, i) {
            String fontKey = ShareVerseFonts.fonts.keys.elementAt(i);
            String displayName = ShareVerseFonts.displayNames[fontKey] ?? fontKey;

            // Use the font itself to display its name
            TextStyle func =
                ShareVerseFonts.fonts[fontKey]!(fontSize: 18, color: Colors.white);
  ...
  TextStyle _getFont(
    ...
    final func = ShareVerseFonts.fonts[fontName] ?? GoogleFonts.inter;
