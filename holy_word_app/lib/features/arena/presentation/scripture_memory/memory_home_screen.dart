...
class MemoryHomeScreen extends ConsumerWidget {
      ...
      body: progressAsync.when(
        ...
        error: (e, _) => Center(
          child: Column(
            ...
            children: [
              const Icon(Icons.psychology_rounded, color: Color(0xFF667eea), size: 80),
  ...
  Widget _buildVerseCard(BuildContext context, MemoryVerse verse) {
    final levelColors = [
      Colors.grey, const Color(0xFF10b981), const Color(0xFF3b82f6),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: levelColors[verse.currentLevel.clamp(0, 5)].withOpacity(0.3)),
      ),
      child: ListTile(
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: levelColors[verse.currentLevel.clamp(0, 5)].withOpacity(0.2),
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('Enter a Bible reference or long-press a verse in the Bible reader.',
                style: TextStyle(color: Colors.white.withOpacity(0.6), fontSize: 13)),
            const SizedBox(height: 16),
            TextField(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(ctx);
              // TODO: Parse reference and add verse
            },
